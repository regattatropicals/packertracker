...
const createScanner = async() => {
  ...
  barcodePicker.handleStartScanning = function handleStartScanning(symbology, callback) {
    ...
    code39SymbologySettings.setActiveSymbolCounts([
      6,
    ]);
  ...
  barcodePicker.handleStopScanning = function handleStopScanning() {
    barcodePicker.eventEmitter._events.scan = null;
    Store.setCurrentlyScanning(false);
  };
